  ...
  return (
    <main className="bg-[rgba(247,243,237,0.56)] pt-12 pb-16 md:pt-20 md:pb-32">
      <Container>
        ...
        <section className="py-8 md:py-20">
          <div className="grid gap-6 md:grid-cols-[0.8fr_1.4fr] md:gap-20">
            ...
            <div className="max-w-3xl space-y-5 text-base leading-7 text-[var(--text-soft)] md:space-y-6 md:text-lg md:leading-8">
              <p>
                I was introduced to electronic data interchange early in my
                career, learning the system alongside an experienced
                subject-matter expert who gave me a strong technical
                foundation. As I developed a deeper understanding of the
                processes and how the pieces connected, I became prepared to
                take ownership of the work independently.
              </p>

              <p>
                The system was technically complex and required careful
                monitoring, testing, and troubleshooting to ensure records
                processed correctly through workflows supporting provider
                payments.
              </p>

              <p className="font-medium text-[var(--text-dark)]">
                I was drawn to the complexity and the challenge of understanding
                the system well enough to recognize, investigate, and resolve
                problems.
              </p>
            </div>
          </div>
        ...
        {/* TECHNICAL WORK */}
        <section className="border-t border-[var(--accent)]/15 py-10 md:py-20">
          <p className="text-xs uppercase tracking-[0.25em] text-[var(--text-soft)]">
            Technical Work
          </p>

          <div className="mt-7 grid gap-10 md:mt-8 md:grid-cols-2">
            <div>
              <h2
            ...
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-[var(--text-soft)]">
                ...
                communicate delays and provide visibility while technical issues
